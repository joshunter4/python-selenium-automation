...
def side_nav_click_add_to_cart(context):
    context.wait.until(EC.presence_of_element_located(SIDE_NAV_ADD_TO_CART_BTN), message='Product was not added to cart')
...
@when('Continue Shopping button')
def continue_shopping_button(context):
    context.driver.find_element(*CONTINUE_SHOPPING_BUTTON).click()
